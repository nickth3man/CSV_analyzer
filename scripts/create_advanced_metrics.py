...
def create_advanced_metrics(db_path: str = "data/nba.duckdb") -> None:
    ...
    try:
        ...
        # =====================================================================
        print("\n=== Creating player_game_advanced view ===")
        ...
        """)
        print("  ✓ Created player_game_advanced view")
        
        # =====================================================================
        # 2. TEAM GAME ADVANCED METRICS VIEW
        # =====================================================================
        print("\n=== Creating team_game_advanced view ===")
        ...
        """)
        print("  ✓ Created team_game_advanced view")
        
        # =====================================================================
        # 3. PLAYER SEASON SUMMARY TABLE
        # =====================================================================
        print("\n=== Creating player_season_stats table ===")
        ...
        """)
        print("  ✓ Created player_season_stats table")
        
        # =====================================================================
        # 4. FOUR FACTORS VIEW (Team Level)
        # =====================================================================
        print("\n=== Creating team_four_factors view ===")
        ...
        conn.execute("""
            ...
            FROM team_game_stats tgs
        """)
        print("  ✓ Created team_four_factors view")
        
        # =====================================================================
        # 5. LEAGUE AVERAGES VIEW (for advanced metric normalization)
        # =====================================================================
        print("\n=== Creating league_season_averages view ===")
        ...
        conn.execute("""
            ...
            GROUP BY season_id
        """)
        print("  ✓ Created league_season_averages view")
        
        # =====================================================================
        # 6. PLAYER CAREER SUMMARY VIEW
        # =====================================================================
        print("\n=== Creating player_career_summary view ===")
        ...
        """)
        print("  ✓ Created player_career_summary view")
        ...
        print("\n" + "=" * 60)
        print("ADVANCED METRICS VIEWS CREATED SUCCESSFULLY")
        print("=" * 60)
        ...
        print("=" * 60)
        print("""
-- Get player game advanced stats:
SELECT * FROM player_game_advanced WHERE player_id = 2544 LIMIT 10;

-- Get team four factors for a season:
SELECT * FROM team_four_factors WHERE season_id = 22023 LIMIT 10;

-- Get league averages by season:
SELECT * FROM league_season_averages ORDER BY season_id DESC;
