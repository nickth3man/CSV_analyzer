...
BOXSCORE_TRADITIONAL_FIELDS = [
    "game_id", "team_id", "team_city", "team_name", "team_tricode",
    "person_id", "first_name", "family_name", "name_i", "player_slug",
    "position", "comment", "jersey_num", "minutes", "field_goals_made",
...
BOXSCORE_ADVANCED_FIELDS = [
    "game_id", "team_id", "team_city", "team_name", "team_tricode",
    "person_id", "first_name", "family_name", "name_i", "player_slug",
    "position", "comment", "jersey_num", "minutes", "off_rating", "def_rating",
    "net_rating", "ast_pct", "ast_to", "ast_ratio", "oreb_pct", "dreb_pct",
    "reb_pct", "tm_tov_pct", "efg_pct", "ts_pct", "usg_pct", "pace", "pie"
]

PLAY_BY_PLAY_FIELDS = [
    "game_id", "action_number", "clock", "period", "person_id", 
    "team_id", "team_tricode", "action_type", "sub_type", "descriptor",
    "area", "loc_x", "loc_y", "shot_distance", "option1", "option2",
    "option3", "option4", "description", "home_description", 
    "neutral_description", "visitor_description", "score", "score_margin"
]

SHOT_CHART_FIELDS = [
    "game_id", "grid_type", "shot_zone_basic", "shot_zone_area", 
...
LEAGUE_STANDINGS_FIELDS = [
    "team_id", "league_id", "season_id", "team", "team_city", "team_name",
    "team_abbreviation", "conference", "conference_record", "playoff_rank",
    "clinch_indicator", "division", "division_record", "division_rank",
    "wins", "losses", "win_pct", "league_rank", "record", "home_record",
    "road_record", "return_to_play_eligibility_flag"
]

PLAYER_TRACKING_FIELDS = [
    "player_id", "player_name", "team_id", "team_abbreviation", 
    "age", "games_played", "wins", "losses", "minutes", "speed", 
    "distance", "touches", "secondary_assists", "free_throw_assists",
    "passes", "assist_points_created", "time_of_possession", 
    "drives", "points_per_drive", "pass_pct", "shoot_pct", 
    "turnover_pct", "foul_pct"
]

HUSTLE_FIELDS = [
    "player_id", "player_name", "team_id", "team_abbreviation", 
    "age", "games_played", "minutes", "deflections", "deflections_per_game",
    "loose_balls_recovered", "loose_balls_recovered_per_game", 
    "charges_drawn", "charges_drawn_per_game", "screen_assists", 
    "screen_assist_points", "screen_assists_per_game", 
